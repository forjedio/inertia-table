# @forjedio/inertia-table-vue

Vue 3 components for [Forjed Inertia Table](https://inertia-table.forjed.io/) — backend-driven dynamic tables for Laravel + Inertia.js.
...
```css
@import "tailwindcss";
@source "../../node_modules/@forjedio/inertia-table-vue";
```
...
export default {
    content: [
        './resources/**/*.{vue,js,ts}',
        './node_modules/@forjedio/inertia-table-vue/dist/**/*.{js,cjs}',
    ],
    // ...
}
```
